...
namespace OnlineShop.Data.Migrations
{
    ...
    [Migration("20200222171010_addOrderAndOrderdetails")]
            ...
            modelBuilder.Entity("OnlineShop.Models.Products", b =>
                {
                    ...
                    b.Property<int>("SerialTagsId");

                    b.HasKey("Id");

                    b.HasIndex("ProductTypesId");

                    b.HasIndex("SerialTagsId");

                    b.ToTable("Products");
                });

            modelBuilder.Entity("OnlineShop.Models.SerialTags", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnlineShop.Models.Products", b =>
                {
                    ...
                    b.HasOne("OnlineShop.Models.SerialTags", "SerialTags")
                        .WithMany()
                        .HasForeignKey("SerialTagsId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
